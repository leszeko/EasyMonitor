...
[SolydXK]
    ...
    Release Model: Fixed
    Status: Active
    Popularity: 109 (110 hits per day) 
...
Popularity (hits per day): 12 months: 98 (132), 6 months: 109 (110), 3 months: 116 (105), 4 weeks: 128 (81), 1 week: 124 (72)
...
Home Page 	http://solydxk.com/
Mailing Lists 	--
User Forums 	http://forums.solydxk.com/
Alternative User Forums 	LinuxQuestions.org
Documentation 	http://solydxk.com/community/tutorials/
Screenshots 	LinuxQuestions.org • DistroWatch Gallery
Screencasts 	LinuxQuestions.org
Download Mirrors 	http://downloads.solydxk.com/ • LinuxTracker.org
Bug Tracker 	--
Related Websites 	 
Reviews 	2015: DistroWatch
2014: DistroWatch • Blogspot
2013: ZDNet • LinuxBSDos • Blogspot • Blogspot • Everyday Linux User • Linux Insider • Dedoimedo • Linux Za Sve (Croatian)
Where To Buy 	OSDisc.com (sponsored link)
EOF
)
#
home_page[X]="http://solydxk.com/"
#
distro[X]="solyd"								# fitst distro[X] = null end array of distros/packages..
version[X]=""
desktop[X]="x"
arch[X]="64_latest"
file_type[X]=".iso"
...
#
: ${mirrors[X]="
 http://downloads.solydxk.com/ http://downloads.solydxk.com/solydx/
 http://ftp.nluug.nl/os/Linux/distr/solydxk/downloads/
 "}
#
...
append_x="boot=live config  memtest noapic noapm nodma nomce nolapic nomodeset nosmp nosplash vga=normal"
add_to_grub_menu
add_to_xxx_menu
}
...
The Live user is “solydxk” and has the same password as root: solydxk.
"
#
#!FIXME ### --- New Item ------ ###
X=2
