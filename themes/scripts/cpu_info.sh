...
Color_terminal_variables
#################
echo "$n$LGreen # cpu_info.sh script # $Reset"

echo "$n$LGreen # File : cat /proc/cpuinfo :$Reset$n"
cat /proc/cpuinfo

echo "$n$LGreen # Command: lscpu :$Reset$n"
lscpu

echo "$n$LGreen # Command: uname -p :$Reset$n"
uname -p

echo "$n$LGreen # Command: uname -m :$Reset$n"
uname -m

echo "$n$LGreen # Command: grep bogo /proc/cpuinfo :$Reset$n"
