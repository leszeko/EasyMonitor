...
[RancherOS]
    ...
    Architecture: x86_64
    Desktop: --
    Category: Docker, Raspberry Pi
    Release Model: Rolling
    Status: Active
    Popularity: 67 (185 hits per day) 
 https://releases.rancher.com/os/latest/rancheros.iso
EOF
)
#
home_page[X]="http://rancher.com/"
#
distro[X]="rancheros"								# fitst distro[X] = null end array of distros/packages..
version[X]=""
desktop[X]=""
arch[X]=""
file_type[X]=".iso"
...
sum[X]="iso-checksums.txt" 				# file with sum to download or sum
