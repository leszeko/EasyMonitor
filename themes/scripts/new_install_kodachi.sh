...
comment[X]=$(cat<<-EOF
Linux Kodachi
Last Update: 2017-01-10 12:23 UTC
...
[Linux Kodachi]
    ...
    Init: systemd
    Status: Active
    Popularity: 114 (85 hits per day) 
...
Popularity (hits per day): 12 months: 106 (105), 6 months: 114 (85), 3 months: 130 (66), 4 weeks: 144 (46), 1 week: 142 (44)

Average visitor rating: 9.75/10 from 4 review(s).


Kodachi Summary
Distribution 	Linux Kodachi
Home Page 	https://www.digi77.com/linux-kodachi/
Mailing Lists 	--
User Forums 	--
Alternative User Forums 	LinuxQuestions.org
Documentation 	--
Screenshots 	https://www.digi77.com/linux-kodachi/ • DistroWatch Gallery
Screencasts 	
Download Mirrors 	https://www.digi77.com/linux-kodachi/
Bug Tracker 	--
Related Websites 	 
Reviews 	 
...
Recent Related News and Releases
 ...
 • 2016-12-30: Distribution Release: Linux Kodachi 3.5"
EOF
)
#
home_page[X]="https://www.digi77.com/linux-kodachi/"
#
distro[X]="kodachi"								# fitst distro[X] = null end array of distros/packages..
version[X]="-3.6"
desktop[X]=""
arch[X]="-64"
file_type[X]=".iso"
...
sum[X]="Kodachi 3.6-hash.txt" 				# file with sum to download or sum
...
#
: ${mirrors[X]="
 https://www.digi77.com/software/kodachi/
 "}
#
...
append_x="config noapic noapm nodma nomce nolapic pci=nomsi nomodeset radeon.modeset=0 nouveau.modeset=0 nosmp vga=normal"
add_to_grub_menu
add_to_xxx_menu
}
