...
comment[X]=$(cat<<-EOF
Pardus Topluluk
Last Update: 2017-07-06 18:28 UTC
...
[Pardus Topluluk]
    ...
    Init: systemd
    Status: Active
    Popularity: 185 (50 hits per day) 

Pardus is a GNU/Linux distribution jointly developed by the Scientific & Technological Research Council of Turkey (TÜBİTAK) and National Academic Network and Information Centre (ULAKBİM). It started its life as a Gentoo-based project before developing its own unique identity. Since late 2012 the distribution, developed in two separate branches as "Corporate" and "Community" editions, is based on Debian.

Popularity (hits per day): 12 months: 187 (46), 6 months: 185 (50), 3 months: 140 (65), 4 weeks: 62 (180), 1 week: 9 (753)

Average visitor rating: 6/10 from 7 review(s).


Pardus Summary
Distribution 	Pardus
Home Page 	http://www.pardus.org.tr/
Mailing Lists 	--
User Forums 	http://www.pardus.org.tr/forum
Alternative User Forums 	http://pardusforum.com/ • LinuxQuestions.org
Documentation 	http://pardustopluluk.org/belgeler/yardim-dokumanlari.html
Screenshots 	DistroWatch Gallery
Screencasts 	
Download Mirrors 	http://www.pardus.org.tr/surumler/
Bug Tracker 	--
Related Websites 	Wikipedia
Reviews 	2.0: Blogspot
2013: Linux User
2011: LinuxBSDos • LinuxBSDos • Linux is my life • DistroWatch • Dedoimedo • Blogspot • LinuxBSDos
2009: LinuxBSDos • Blogspot • Ghacks • Wordpress • LinuxBSDos • Blogspot (Spanish) • Dedoimedo • Adventures In Open Source • DistroWatch • LinuxBSDos • IT Lure
2008: Linux.com • FOSSwire • Tech Source • Wordpress
2007: Junauza • Linux.com • LinMagazine (Hebrew) • Seopher • Wordpress • DistroWatch
Where To Buy 	OSDisc.com (sponsored link)
EOF
)
#
home_page[X]="http://www.pardus.org.tr/pardus17-surum-notlari/"
#
distro[X]="Pardus-17.0-amd64"
version[X]=""
desktop[X]=""
arch[X]=""
file_type[X]=".iso"
...
#
: ${mirrors[X]="http://depo.pardus.org.tr/pub/ISO/Pardus17/"}
#
...
append_x="boot=live components locales=en_US.UTF-8 keyboard-layouts=us username=pardus hostname=pardus user-fullname=Pardus splash quiet --"
...
home_page[X]="http://www.pardus.org.tr/pardus17-surum-notlari/"
#
distro[X]="Pardus-17.1-DDE-amd64"
version[X]=""
desktop[X]=""
arch[X]=""
file_type[X]=".iso"
...
home_page[X]="http://www.pardus.org.tr/pardus17-surum-notlari/"
#
distro[X]="Pardus-17.1-XFCE-amd64"
version[X]=""
desktop[X]=""
arch[X]=""
file_type[X]=".iso"
