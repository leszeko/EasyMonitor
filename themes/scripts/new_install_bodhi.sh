...
comment[X]=$(cat<<-EOF
Bodhi Linux
Last Update: 2016-10-29 12:39 UTC
...
[Bodhi Linux]
    ...
    Release Model: Fixed
    Status: Active
    Popularity: 37 (311 hits per day) 
...
Popularity (hits per day): 12 months: 34 (306), 6 months: 37 (311), 3 months: 39 (302), 4 weeks: 54 (253), 1 week: 53 (245)
...
Home Page 	http://www.bodhilinux.com/
Mailing Lists 	--
User Forums 	http://forums.bodhilinux.com/
Alternative User Forums 	LinuxQuestions.org
Documentation 	http://wiki.bodhilinux.com/
Screenshots 	LinuxQuestions.org • DistroWatch Gallery
Screencasts 	LinuxQuestions.org
Download Mirrors 	http://sourceforge.net/projects/bodhilinux/files/ • LinuxTracker.org
Bug Tracker 	--
Related Websites 	 
Reviews 	4.x: DistroWatch
3.x: Desktop Linux Reviews • DistroWatch
2.x: Wordpress • Linux User • DistroWatch • LinuxBSDos • Dedoimedo • FOSS Force • Blogspot • aboutLinux • Linux Za Sve (Croatian) • DistroWatch
1.x: Linux and Life • Linux.com • DistroWatch • Blogspot • Make Use Of • Blogspot • TechWorld
Where To Buy 	OSDisc.com (sponsored link)
EOF
)
#
home_page[X]="http://www.bodhilinux.com/"
#
distro[X]="bodhi"								# fitst distro[X] = null end array of distros/packages..
version[X]="-4.1.0-apppack"
desktop[X]=""
arch[X]="-32"
file_type[X]=".iso"
...
#
: ${mirrors[X]="
 https://sourceforge.net/projects/bodhilinux/files/4.1.0/
 "}
#
...
append_x="file=/cdrom/preseed/custom.seed boot=casper nomodeset xforcevesa quiet splash --"
add_to_grub_menu
add_to_xxx_menu
}
