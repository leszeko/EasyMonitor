...
comment[X]=$(cat<<-EOF
Parsix GNU/Linux
Last Update: 2017-01-25 14:09 UTC
...
[Parsix GNU/Linux]
    ...
    Release Model: Fixed
    Status: Active
    Popularity: 132 (81 hits per day) 
...
Popularity (hits per day): 12 months: 110 (103), 6 months: 132 (81), 3 months: 136 (82), 4 weeks: 227 (36), 1 week: 229 (33)

No vistor rating given yet. Rate this project.


Parsix Summary
Distribution 	Parsix GNU/Linux
Home Page 	http://www.parsix.org/
Mailing Lists 	http://www.parsix.org/cgi-bin/mailman/listinfo/parsix-users
User Forums 	http://forums.parsix.org/
Alternative User Forums 	LinuxQuestions.org
Documentation 	http://www.parsix.org/wiki/Documentation
Screenshots 	LinuxQuestions.org • DistroWatch Gallery
Screencasts 	LinuxQuestions.org
Download Mirrors 	http://sourceforge.net/projects/xfardic/files/Parsix-Mirror/
Bug Tracker 	http://bugs.parsix.org/
Related Websites 	Wikipedia
Reviews 	8.5: DistroWatch
8.0: DistroWatch
7.x: DistroWatch
5.x: LinuxBSDos
3.x: DistroWatch • LinuxBSDos • Linux Review (Persian) • IT Lure • LinuxBSDos
1.x: DistroWatch
Where To Buy 	OSDisc.com (sponsored link)
EOF
)
#
home_page[X]="http://www.parsix.org/"
#
distro[X]="parsix"								# fitst distro[X] = null end array of distros/packages..
version[X]="_8.15r0"
desktop[X]=""
arch[X]="-i386"
file_type[X]=".iso"
...
#
: ${mirrors[X]="
 https://sourceforge.net/projects/xfardic/files/Parsix-Mirror/8.15r0/
 "}
#
...
append_x="boot=parsix init=/bin/systemd vga=normal nomce quiet radeon.modeset=1 i915.modeset=1 nouveau.modeset=1 --"
initrd_x="/boot/isolinux/initrd"
add_to_grub_menu
add_to_xxx_menu
add_menu_label_x="(failsafe)"
append_x="boot=parsix init=/bin/systemd vga=normal xmodule=vesa nomce quiet radeon.modeset=0 i915.modeset=0 nouveau.modeset=0 i915.i915_enable_rc6=0 --"
add_to_grub_menu
add_to_xxx_menu
}
