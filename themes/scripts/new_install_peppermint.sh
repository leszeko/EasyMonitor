...
comment[X]=$(cat<<-EOF
Peppermint OS
Last Update: 2016-12-01 18:33 UTC
...
[Peppermint OS]
    ...
    Release Model: Fixed
    Status: Active
    Popularity: 27 (393 hits per day) 
...
Popularity (hits per day): 12 months: 29 (362), 6 months: 27 (393), 3 months: 22 (447), 4 weeks: 33 (368), 1 week: 30 (434)
...
Mailing Lists 	--
User Forums 	http://forum.peppermintos.com/
Alternative User Forums 	LinuxQuestions.org
Documentation 	--
Screenshots 	LinuxQuestions.org • DistroWatch Gallery
Screencasts 	LinuxQuestions.org
Download Mirrors 	http://peppermintos.com/download • LinuxTracker.org
Bug Tracker 	http://getsatisfaction.com/peppermintos
Related Websites 	 
Reviews 	7: DistroWatch • Everyday Linux User
Five: LinuxInsider • Blogspot
Four: Everyday Linux User • Wordpress • ITworld • DistroWatch • Blogspot
Three: DarkDuck • Everyday Linux User • DistroWatch
Two: Wordpress • Gnuman • Linux User • Wordpress
Ice: Ubuntu Musings • Computerworld
One: Dedoimedo • Jim Lynch • IT Lure • DistroWatch • Wordpress • Blogspot • Wordpress
Where To Buy 	OSDisc.com (sponsored link)
EOF
)
#
home_page[X]="http://peppermintos.com/"
#
distro[X]="Peppermint"								# fitst distro[X] = null end array of distros/packages..
version[X]="-7-20161201"
desktop[X]=""
arch[X]="-i386"
file_type[X]=".iso"
...
sum[X]="0d808300bb692c037f41054f5d59dee8" 				# file with sum to download or sum
...
append_x="noprompt cdrom-detect/try-usb=true file=/cdrom/preseed/peppermint.seed boot=casper quiet splash --"
initrd_x="/casper/initrd.lz"
add_to_grub_menu
add_to_xxx_menu
add_menu_label_x="Install"
append_x="noprompt cdrom-detect/try-usb=true file=/cdrom/preseed/peppermint.seed boot=casper only-ubiquity quiet splash --"
add_to_grub_menu
add_to_xxx_menu
}
