...
#
home_page[X]="https://chakralinux.org/"
#
distro[X]="slackware"								# fitst distro[X] = null end array of distros/packages..
version[X]="64-live"
desktop[X]="-plasma5-current"
arch[X]=""
file_type[X]=".iso"
...
kernel_x="/boot/generic"
iso_command_x="img_dev=$dev_name img_loop="
append_x="load_ramdisk=1 prompt_ramdisk=0 rw printk.time=0 kbd=pl tz=localtime locale=pl_PL.utf8 xkb=pl"
initrd_x="/boot/initrd.img"
#root=your_iso_image isoloop=$isofile
# cp -rf "/mnt/$file_name_1/liveslak" "/liveslak"
add_to_grub_menu
add_to_xxx_menu
add_menu_label_x="Live (non free)"
append_x="chakraisolabel=CHAKRA_2017-02-20 nonfree=yes xdriver=no radeon.modeset=0"
add_to_grub_menu
add_to_xxx_menu
}
