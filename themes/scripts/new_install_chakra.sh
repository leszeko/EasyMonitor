...
comment[X]=$(cat<<-EOF
Chakra GNU/Linux
Last Update: 2017-03-14 23:33 UTC

[Chakra GNU/Linux]

    OS Type: Linux
    Based on: Indpendent (forked from Arch)
    Origin: Germany
    Architecture: x86_64
    Desktop: KDE Plasma
    ...
    Status: Active
    Popularity: 66 (188 hits per day) 
...
Popularity (hits per day): 12 months: 74 (166), 6 months: 66 (188), 3 months: 51 (235), 4 weeks: 25 (425), 1 week: 6 (1,302)

Average visitor rating: 8.67/10 from 3 review(s).


Chakra Summary
Distribution 	Chakra GNU/Linux
Home Page 	https://chakralinux.org/
Mailing Lists 	https://groups.google.com/forum/#!topic/chakra-devel • https://groups.google.com/forum/#!topic/chakra-packagers
User Forums 	https://chakralinux.org/forum
Alternative User Forums 	LinuxQuestions.org
Documentation 	https://chakralinux.org/wiki
Screenshots 	LinuxQuestions.org • DistroWatch Gallery
Screencasts 	LinuxQuestions.org
Download Mirrors 	https://chakralinux.org/ • LinuxTracker.org
Bug Tracker 	https://chakralinux.org/bugtracker
Related Websites 	Chakra Brazil • Chakra Italy • Chakra Spain
Reviews 	2015: DistroWatch • Everyday Linux User
2014: Dedoimedo • DistroWatch • Blogspot • DistroWatch • Blogspot
2013: ABC Linuxu (Czech) • DistroWatch • LinuxBSDos
2012: Dedoimedo • LinuxBSDos • Linux User • LinuxBSDos • DistroWatch • LWN • Blogspot • LinuxBSDos
2011: LinuxBSDos • LinuxBSDos • Dedoimedo • DistroWatch • Linux Review (Farsi) • Linux User • LinuxBSDos
0.x: DistroWatch • Blogspot • Blogspot
...
#
distro[X]="chakra"								# fitst distro[X] = null end array of distros/packages..
version[X]="-2017.03-goedel-"
desktop[X]=""
arch[X]="x86_64"
file_type[X]=".iso"
...
#
: ${mirrors[X]="
 https://sourceforge.net/projects/chakra/files/2017.03/
 "}
#
...
kernel_x="/chakra/boot/x86_64/chakraiso"
iso_command_x="img_dev=$dev_name img_loop="
append_x="chakraisolabel=CHAKRA_2017-02-20 nonfree=no xdriver=no"
initrd_x="/chakra/boot/x86_64/chakraiso.img"
add_to_grub_menu
add_to_xxx_menu
