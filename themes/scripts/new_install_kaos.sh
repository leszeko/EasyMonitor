...
comment[X]=$(cat<<-EOF
Ostatnia aktualizacja: 2017-07-13 22:53 UTC
...
[KaOS]
    ...
    Init: systemd
    Status: Aktywna
    Popularność: 43 (257 trafień dziennie) 
...
Popularność (trafień dziennie): 12 miesięcy: 38 (286), 6 miesięcy: 43 (257), 3 miesięcy: 41 (250), 4 tygodnie: 52 (213), 1 tydzień: 71 (138)
...
KaOS Summary
Dystrybucja 	KaOS
Strona domowa 	http://kaosx.us/
Listy pocztowe 	https://groups.google.com/forum/?fromgroups#!forum/kaos-general
Forum użytkowników 	http://kaosx.us/phpBB3/
Alternative User Forums 	LinuxQuestions.org
Dokumentacja 	--
Zrzuty ekranu 	DistroWatch Gallery
Screencasts 	
Serwery lustrzane 	https://sourceforge.net/projects/kaosx/files/ http://kaosx.us/download/ • LinuxTracker.org
Bug Tracker 	https://github.com/KaOSx/
Strony zwązane 	 
Recenzje 	2016: Dedoimedo
2015: Hectic Geek
2014: Dedoimedo • DistroWatch • ZDNet • Blogspot • DistroWatch • Hectic Geek
Gdzie kupić 	OSDisc.com (sponsored link)
EOF
)
#
home_page[X]="http://kaosx.us"
#
distro[X]="KaOS"								# fitst distro[X] = null end array of distros/packages..
version[X]="-2017.01"
desktop[X]=""
arch[X]="-x86_64"
file_type[X]=".iso"
file_name[X]="${distro[X]}${version[X]}${desktop[X]}${arch[X]}${file_type[X]}"	# the file to downloda - comment name to disable
sum[X]="2051d7c0ad3cb24dc95103b291faf987" 					# file with sum to download or sum
...
#
: ${mirrors[X]="
 https://sourceforge.net/projects/kaosx/files/ISO/
...
kernel_x="/kdeos/boot/x86_64/kdeosiso"
iso_command_x="img_dev=$dev_name img_loop="
append_x="kdeosisobasedir=kdeos kdeosisolabel=KAOS_20170103 nonfree=no xdriver=no i915.modeset=1 nouveau.modeset=1 radeon.modeset=1 systemd.show_status=0"
initrd_x="/kdeos/boot/x86_64/kdeosiso.img"
add_to_grub_menu
add_to_xxx_menu
add_menu_label_x="Live (non free)"
append_x="kdeosisobasedir=kdeos kdeosisolabel=KAOS_20170103 nonfree=yes xdriver=no i915.modeset=1 radeon.modeset=1 systemd.show_status=0"
add_to_grub_menu
add_to_xxx_menu
}
...
home_page[X]="http://kaosx.us"
#
distro[X]="KaOS-2017.07-x86_64"
desktop[X]=""
arch[X]=""
version[X]=""
file_type[X]=".iso"
file_name[X]="${distro[X]}${version[X]}${desktop[X]}${arch[X]}${file_type[X]}"
sum[X]="bc235b1f6d914b861a0801ab8f4727f2c8695f4a"
