...
[Netrunner]
    ...
    Status: Active
    Popularity: 38 (304 hits per day) 

Netrunner is a KDEneon-based distribution featuring a highly customised KDE desktop with extra applications, multimedia codecs, Flash and Java plugins, and a unique look and feel. The modifications are designed to enhance the user-friendliness of the desktop environment while still preserving the freedom to tweak. A separate "Rolling" edition, based on Manjaro Linux, was launched in 2014.

Popularity (hits per day): 12 months: 35 (295), 6 months: 38 (304), 3 months: 30 (390), 4 weeks: 18 (511), 1 week: 42 (317)
...
Home Page 	http://www.netrunner.com/
Mailing Lists 	--
User Forums 	http://forums.netrunner.com/
Alternative User Forums 	LinuxQuestions.org
Documentation 	http://www.netrunner.com/faq/
Screenshots 	http://www.netrunner.com/screenshots/ • LinuxQuestions.org • DistroWatch Gallery
Screencasts 	LinuxQuestions.org
Download Mirrors 	http://www.netrunner.com/download/ • LinuxTracker.org
Bug Tracker 	https://bugs.launchpad.net/netrunner
Related Websites 	Netrunner Mag • Wikipedia
EOF
)
#
home_page[X]="http://www.netrunner.com/"
#
distro[X]="netrunner"								# fitst distro[X] = null end array of distros/packages..
version[X]="-desktop-1701"
desktop[X]=""
arch[X]="-64bit"
file_type[X]=".iso"
...
sum[X]="45e38696371c6441cc6570b54e765cd7f5777862a41f4f181575aa75aa3ba07d" 				# file with sum to download or sum
...
#
: ${mirrors[X]="
 https://netix.dl.sourceforge.net/project/netrunneros/netrunner-1701/
 "}
#
...
append_x="boot=live hostname=live-pc username=live live-config.user-default-groups=sambashare,cdrom,floppy,audio,dip,video,plugdev,netdev,lpadmin,scanner,bluetooth,adm quiet splash"
initrd_x="/live/initrd.img"
add_to_grub_menu
add_to_xxx_menu
add_menu_label_x="(failsafe)"
append_x="boot=live hostname=live-pc username=live live-config.user-default-groups=sambashare,cdrom,floppy,audio,dip,video,plugdev,netdev,lpadmin,scanner,bluetooth,adm quiet splash memtest noapic noapm nodma nomce nolapic nomodeset nosmp nosplash vga=normal"
add_to_grub_menu
add_to_xxx_menu
}
