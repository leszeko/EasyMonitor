...
comment[X]=$(cat<<-EOF
Rebellin Linux
Last Update: 2017-02-21 10:27 UTC
...
[Rebellin Linux]
    ...
    Release Model: Fixed
    Status: Active
    Popularity: 225 (37 hits per day) 
...
Popularity (hits per day): 12 months: 168 (58), 6 months: 225 (37), 3 months: 209 (42), 4 weeks: 148 (64), 1 week: 72 (171)

No vistor rating given yet. Rate this project.


Rebellin Summary
Distribution 	Rebellin Linux
Home Page 	http://www.therebellin.com/
Mailing Lists 	--
User Forums 	https://therebellin.com/rebellin-linux-forums/
Alternative User Forums 	LinuxQuestions.org
Documentation 	--
Screenshots 	LinuxQuestions.org • DistroWatch Gallery
Screencasts 	LinuxQuestions.org
Download Mirrors 	https://therebellin.com/download-rebellin-linux/ • LinuxTracker.org
Bug Tracker 	--
Related Websites 	 
Reviews 	1.00: DistroWatch

Looking for the latest version? Download RebellinGnome-64bit.iso (1.9 GB)
Home / rebellin_v3_5
Name 	Modified 	Size 	Downloads / Week 	Status
Parent folder
RebellinMate-64bit.iso 	2017-02-20 	1.9 GB 	4444 weekly downloads 	i
RebellinMate-32bit.iso 	2017-02-20 	2.1 GB 	1919 weekly downloads 	i
RebellinGnome-64bit.iso 	2017-02-20 	1.9 GB 	173173 weekly downloads 	i
RebellinGnome-32bit.iso 	2017-02-20 	1.9 GB 	1111 weekly downloads 	i
Totals: 4 Items 	  	7.8 GB 	247 	
EOF
)
#
home_page[X]="http://www.therebellin.com/"
#
distro[X]="Rebellin"								# fitst distro[X] = null end array of distros/packages..
version[X]=""
desktop[X]="Gnome"
arch[X]="-32bit"
file_type[X]=".iso"
...
sum[X]="875f2c1584861294bd18e84bed74a5c0f68f6606" 				# file with sum to download or sum
...
#
: ${mirrors[X]="
 https://sourceforge.net/projects/rebellinlinux/files/rebellin_v3_5/
 "}
#
...
append_x="boot=live config username=live init=/bin/systemd quiet"
...
add_to_grub_menu
add_to_xxx_menu
add_menu_label_x="GUI Install"
kernel_x="/install/gtk/vmlinuz"
iso_command_x="findiso="
append_x="video=vesa:ywrap,mtrr vga=788 quiet"
initrd_x="/install/gtk/initrd.gz"
add_to_grub_menu
add_to_xxx_menu
}
...
file_type[X]=".iso"
file_name[X]="${distro[X]}${version[X]}${desktop[X]}${arch[X]}${file_type[X]}"	# the file to downloda - comment name to disable - end of playing at split name in sections :)
sum[X]="2b1a18e016e3beb1b9c44e86d09ed958875d9638" 				# file with sum to download or sum
# sum_file[X]="${sum[X]}"							# comment file name to disable if sum is set
# gpg[X]="${file_name[X]}.sig"
# gpg_file[X]="${gpg[X]}"
install_folder[X]="/ISO/${distro[X]}${version[X]}${desktop[X]}${arch[X]}_iso"	# folder for download iso file from mirros
