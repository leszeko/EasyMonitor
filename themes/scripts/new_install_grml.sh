...
comment[X]=$(cat<<-EOF
Grml
Last Update: 2017-05-08 23:33 UTC
...
[Grml]
    ...
    Release Model: Fixed
    Status: Active
    Popularity: 163 (59 hits per day) 
...
Popularity (hits per day): 12 months: 193 (44), 6 months: 163 (59), 3 months: 132 (87), 4 weeks: 58 (203), 1 week: 11 (782)

Average visitor rating: 9.33/10 from 3 review(s).


Grml Summary
Distribution 	Grml
Home Page 	http://www.grml.org/
Mailing Lists 	http://www.grml.org/mailinglist/
User Forums 	--
Alternative User Forums 	LinuxQuestions.org
Documentation 	http://www.grml.org/docs/
Screenshots 	http://grml.org/screenshots/ • DistroWatch Gallery
Screencasts 	
Download Mirrors 	http://grml.org/download/mirrors/
Related Websites 	Freecode
Reviews 	2011.12: Blogspot
Where To Buy 	OSDisc.com (sponsored link)
EOF
)
#
home_page[X]="http://www.grml.org"
#
distro[X]="grml64-full_2014.11"
version[X]=""
desktop[X]=""
arch[X]=""
file_type[X]=".iso"
...
#sum[X]=""
#sum_file[X]="${sum[X]}"
gpg[X]="grml64-full_2014.11.iso.sha1.asc"
gpg_file[X]="${gpg[X]}"
...
home_page[X]="http://www.grml.org"
#
distro[X]="grml64-full_2017.05-rc1"
version[X]=""
desktop[X]=""
arch[X]=""
file_type[X]=".iso"
...
#sum[X]=""
#sum_file[X]="${sum[X]}"
gpg[X]="grml64-full_2017.05-rc1.iso.asc"
gpg_file[X]="${gpg[X]}"
install_folder[X]="/ISO/${distro[X]}${version[X]}${desktop[X]}${arch[X]}_iso"
#
: ${mirrors[X]="
http://ftp.fau.de/grml//
http://mirror.netcologne.de/grml//
http://ftp.gwdg.de/pub/linux/grml//devel/
"}
#
use_get_download_parameters[X]="yes"
use_install_script[X]="no"
